<template>
  <div class="max-w-screen-xl mx-auto pb-12 px-4 sm:pb-16 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
      <div
        class="bg-white shadow rounded-lg px-4 py-4 text-base font-normal text-gray-700"
      >
        <p>Last updated: July 02, 2020</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Welcome To Sicily.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Welcome To Sicily, accessible
              from
              <a
                href="welcometosicily.app"
                rel="external nofollow noopener"
                target="_blank"
                >welcometosicily.app</a
              >
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: hello@welcometosicily.app</li>
        </ul>
      </div>
    </div>
  </div>
